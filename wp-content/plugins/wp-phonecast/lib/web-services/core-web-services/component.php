...
class WppcWebServiceComponent{

	public static function hooks(){
		add_filter('wppc_read_one_component',array(__CLASS__,'read_one'),10,3);
	}
	...
	public function read_one($service_answer,$id,$app_id){
		...
		$service_answer = WppcComponents::get_component_data($app_id,$component_slug,$args);
