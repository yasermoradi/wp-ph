var WppcComponents = (function ($){
		...
		wppc.ajax_add_or_edit_component_row = function(data,callback){
			//TODO : add nonce (via wp_localize_script...)
			var data = {
				action: 'wppc_edit_component',
		...
		wppc.ajax_delete_component_row = function(post_id,component_id,callback){
...
jQuery().ready(function(){
	...
	$('#components-wrapper').on('click','a.component-form-submit',function(e){
		...
		WppcComponents.ajax_add_or_edit_component_row(serializeObject(data),function(answer){
			if( answer.ok == 1 ){
	...
	$('#components-wrapper').on('click','a.delete_component',function(e){
		...
		WppcComponents.ajax_delete_component_row(post_id,component_id,function(answer){
			if( answer.ok == 1 ){
	...
	$('#components-wrapper').on('change','.component-type',function(e){
		...
		WppcComponents.ajax_update_component_type(this,type);
	});
