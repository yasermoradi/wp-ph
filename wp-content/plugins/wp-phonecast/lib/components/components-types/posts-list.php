...
class WppcComponentTypePostsList extends WppcComponentType{
	...
	protected function compute_data($component,$options,$args=array()){
		...
		if( $options['post-type'] != 'custom' ){
			...
			//hook "wppc_posts_list_custom-[your-hook]" to set the component posts.
			
			//The wppc_posts_list_custom-[your-hook] filter must return the given $posts_list_data filled in with
			//your custom data :
...
WppcComponentsTypes::register_component_type('posts-list', array('label'=> __('Posts list')));