<?php
class WppcComponentTypeHooks extends WppcComponentType{
	...
	protected function compute_data($component,$options,$args=array()){
		...
		$component_data = apply_filters('wppc_custom_component-'. $options['hook'],$component_default_data,$component,$options,$args);
...
WppcComponentsTypes::register_component_type('hooks', array('label'=> __('Custom component, using hooks')));