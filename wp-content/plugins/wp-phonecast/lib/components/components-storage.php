...
class WppcComponentsStorage{
	...
	public static function add_or_update_component($app_id,WppcComponent $component,$component_id=0){
	...
	public static function get_component_id($app_id,WppcComponent $component){
